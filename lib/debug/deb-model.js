...
class ModelMaker extends RNav_ModelMaker {
    ...
    recognize(srcObj, chief, path) {
        ...
        if (path.match(/.*\/animals\[\d+\]$/)) {
            const id = `${srcObj.species}-${srcObj.name}` + RNav_Gear.getNextIdCount();
...
class AnimalCtrl extends RNav_BasicDOMControl {
    ...
    makeDOMView() {
        ...
        const look = (new RNav_ImgViewMaker())
...
class CageCtrl extends RNav_BasicDOMControl {
...
class ZooCtrl extends RNav_DOMControl {
    ...
    makeDOMView() {
        ...
        const vm = (new RNav_TableShellViewMaker())
...
class TextDirectionButton extends RNav_FlipperButton {
    ...
    performButtonAction(task) {
        ...
        RNav_DOMUtils.setTextDirection(
...
class AnimalDescCtrl extends RNav_DOMControl {
    ...
    makeDOMView() {
        ...
        const vm = new RNav_RackViewMaker(rackPropsRec, 'animalInfo')
            .setOrigin(this)
            .nestProps(
                {
                    'title': 'Gorilla', 
