...
class Animal extends kwish_DOMControl {
    ...
    handle_dom_click(task) {
        kwish_DOMUtils.startTremble(this.getDOMView(), 1, 100, 3000);
    }
} 


class Cage extends kwish_DOMControl {
...
class Zoo extends kwish_DOMControl {
    ...
    buildDOMView() {
        ...
        const vm = (new kwish_TableShellMaker())
...
class MyApp extends kwish_App {

    goOn() {
        console.log('Going on...');

        const page = new kwish_Page(this).usePresetControls();
