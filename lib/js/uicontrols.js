...
class kwish_IconicButton extends kwish_DOMControl {
    ...
    performButtonAction(task) { 
        ...
        if (!!this.callback) {
            ...
            console.log(`${this.getId()}_userActionRequest`);

            this.getMajor().doCommand(`${this.getId()}_userActionRequest`); 
        }
    }
    ...
    performButtonAction(task) { 
        ...
        if (this.getButtonState() === 'hidden') {
            this.showControlledContent()
                .escalateCommand('contentShown');
        } else {
            this.hideControlledContent()
                .escalateCommand('contentHidden');
        }
    }
}
...
class kwish_ShowHideBlock extends kwish_DOMControl {
    ...
    isShown() {
        return this.getShowHideButtonControl().getButtonState() === 'shown';
    }
