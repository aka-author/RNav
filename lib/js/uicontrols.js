...
/*
class RNav_ContentFlipFloper extends RNav_DOMControl {

    constructor(major, propsRec = {}, id = undefined) {

        super(major, propsRec, id);

        this.createFlipFlopButton();
        this.createShelf()
    }

    createFlipFlopButton() {

        new RNav_FlipFlopButton(this)
    ...
    habdle_showContent(task) {
        RNav_DOMUtils.show(this.getContentDOMView());
    }

    handle_hideContent(task) {
        RNav_DOMUtils.hide(this.getContentDOMView());
    }
