...
class RNav_Vertex extends RNav_Generic {
    ...
    constructor(upperVertex, id = undefined) {
        ...
        this.setProps({'cfg': undefined, 'cfgParamNamePrefix': ''});
    }
    ...
    getCfgParamName(shortcut) {
        return `${this.getCfgPparamNamePrefix()}${shortcut}`;
    }
    ...
    addUnderVertex(vertex) {
        ...
        vertex.setUpperVertex(this);
        return this;
    }

    getVertexById(vertexId = undefined) {
