...
class kwish_Bureaucrat extends kwish_Vertex {
    ...
    doCommand(taskTypeName, propagStrategy = kwish_TASK_PRIVAT, payload = null) {
        ...
        const task = new kwish_Task(taskTypeName)
    ...
    createTask(taskTypeName) {
        return kwish_Bureaucrat.createTask(taskTypeName);
    }
    ...
    escalateCommand(taskTypeName, propagStrategy = kwish_TASK_PRIVAT) {
    ...
    static createTask(taskTypeName) {
        return new kwish_Task(taskTypeName).setInitiator(this);
    }
