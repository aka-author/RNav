...
class kwish_MultiIconViewMaker extends kwish_ViewMaker {
    ...
    constructor(id = undefined) {
        ...
        this.setProps(
            {
                'outerElementName': 'div',
                'outerId': `${this.getId()}_outer`,
                'innerElementName': 'div',
                'innerId': `${this.getId()}_inner`,
...
class kwish_RackViewMaker extends kwish_ViewMaker {
    ...
    assembleTemplate() {
        ...
        for (const shelfName of this.getShelfNames()) {
            shelves +=
                `<${outer} 
                ${this.idAttr(this.assembleBlockId('_outer', shelfName))}
                ${this.bemAttr(shelfName + '_outer')}>
                <${inner} 
                    ${this.idAttr(this.assembleBlockId('_inner', shelfName))}
