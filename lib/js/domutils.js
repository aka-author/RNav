...
class RNav_DOMUtils {
    ...
    static replaceCSSClass(domElement, currentCssClassName, replacingCssClassName) {
        requestAnimationFrame(() => {
            RNav_DOMUtils.addCssClass(domElement, replacingCssClassName);
            RNav_DOMUtils.removeCssClass(domElement, currentCssClassName);
        });
