...
class kwish_Gear {
    ...
    constructor(props = null, id = undefined) {
        ...
        this.setProps(corePropsRec, propsRec)
            ...
            .declare(kwish_Setup.fsmStateDefaultPropName)
            .configure()
    ...
    inject(injectee, propName = undefined) {
        ...
        injectee.setInjectedInto(this).acceptBeingInjected();
