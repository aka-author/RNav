...
class kwish_FSMachine extends kwish_Equipment {
    ...
    parsePlantUML(fsmDef) {
        ...
        for(const line of fsmDef.split('\n')) {
            ...
            let dryLine = kwish_Utils.dry(line);
    ...
    getServicedPropName() {
        this.getSingleServicedPropName() || kwish_Setup.fsmStateDefaultPropName;
    }
    ...
    updateServicedProp() {
        ...
        if (this.hasServicedObject()) {
            ...
            const propName = this.getSingleServicedPropName();
