...
function $(srcHTML) {
    return kwish_DOMUtils.dom(srcHTML);
}
...
class TaxonomyTree extends kwish_SelectableTreeControl {
    ...
    assembleTaxCheckbox(srcTreeNodeRec) {
        ...
        checkbox.setAttribute('id', srcTreeNodeRec.value);
...
class Searcher extends kwish_DOMControl {
    ...
    beforeRun() {
        const divEmptyMessage = document.getElementById('No topica have been found.');
...
class PrintButton extends kwish_DOMControl {
    ...
    makeDOMView() {
        ...
        this.inject(new kwish_BoxShellViewMaker())
                .nestProps({'content': spanButton});
