...
class MatterFramelet extends kwish_DOMControl {
    ...
    srcollToAnchor(anchor) {

        const offsetTop = this.getDOMView().offsetTop; 
        const target = document.getElementById(anchor);
        
        if (!!target) { 
            this.getDOMView().scrollTop = target.offsetTop - offsetTop;
        }
...
class App extends kwish_App {
    ...
    getTopicIdByPageFileName(pageURL) {
        ...
        return doc.getTopicIdByPageFileName(pageURL);
    }
